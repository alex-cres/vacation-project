...
if (module_exists("event_calendar_colors")) {
    ...
    $term_color_div="<table class='full'>";
	$w=1;
    foreach ($result_one as $vid) {
        ...
        foreach ($result as $fetch) {
            ...
            $term_color_div .= "<td><div style=' display:inline-block;height:20px;width:20px;background-color:" . $ser_color['background'] . "'>&nbsp;&nbsp;&nbsp;&nbsp;</div> - " . $fetch->name;
